...
public abstract class BaseConfig {
    ...
    public void init(@NotNull JavaPlugin plugin) {
        this.init(plugin, true, plugin.getDataFolder());
    }

    public void init(@NotNull JavaPlugin plugin, File parentDir) {
        this.init(plugin, true, parentDir);
    }

    protected void init(@NotNull JavaPlugin plugin, boolean initializeFields, File parentDir) {
        ...
        this.file = new File(parentDir, fileName);
        try {
